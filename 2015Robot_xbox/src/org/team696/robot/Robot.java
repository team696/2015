...
//    	tankDriveSwitch		= xBoxController.getRa
...
//    	elevatorStick		= controlBoard.getRawAxis(4);
    	closeIntakeButton	= xBoxController.getRawButton(6);
    	
    	/*
    	 * Elevator control with XBox Controller
    	 */
//    	if(xBoxController.getRawButton(10))elevatorStick = xBoxController.getRawAxis(5);
...
//    	presetButtonTop 		= controlBoard.getRawButton(10);
    	 ...
    	 * Elevator control with XBox Controller
    	 */
//    	presetButtonBottom = xBoxController.getRawButton(1);
//    	presetButtonOneToteHigh = xBoxController.getRawButton(2);
//    	presetButtonTwoToteHigh = xBoxController.getRawButton(4);
//    	presetButtonTop 		= xBoxController.getRawBut(10);
...
//    	else if (controlBoard.getRawButton(9))clawOpen = true;
    	oldClawOpen = clawOpen;
    	if(oldClawOpen != clawOpen && clawOpen)claw.set(!claw.get());
    	clawOpen = xBoxController.getRawButton(3);
